...
int main()
{
    ...
    Model fant((char*)"Models/fantasma.obj");
    Model lentes((char*)"Models/lentes.obj");
    Model playa((char*)"Models/playa.obj");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        model = glm::mat4(1.0f);
        model = glm::translate(model, glm::vec3(0.0f, 0.2f, 0.28f));
        model = glm::scale(model, glm::vec3(2.0f));
        glUniformMatrix4fv(glGetUniformLocation(shader.Program, "model"), 1, GL_FALSE, glm::value_ptr(model));
        lentes.Draw(shader);

        model = glm::mat4(1.0f);
        model = glm::translate(model, glm::vec3(0.0f, 0.22f, 0.28f));
        model = glm::scale(model, glm::vec3(0.3f));
        glUniformMatrix4fv(glGetUniformLocation(shader.Program, "model"), 1, GL_FALSE, glm::value_ptr(model));
        sombrero.Draw(shader);

        model = glm::mat4(1.0f);
        model = glm::translate(model, glm::vec3(-0.3f, -0.5f, 0.28f));
        model = glm::scale(model, glm::vec3(0.3f));
